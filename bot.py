...
PRODUCTS={
"König Combi Linie Plus":["Багет злаковый","Багет молочный","Багет сырный","Булочка для гамбургеров без кунжута","Булочка для френч-дога","Булочка для хот-дога белая","Бейгл с кунжутом"],
"König Ceres":["Багет французский","Багет ремесленный","Хлеб бездрожжевой с семечками","Хлеб гречишный","Хлеб картофельный","Хлеб тыквенный","Хлеб кефирный","Хлеб протеиновый","Хлеб пшеничный домашний","Хлеб с семенами чиа и пажитником","Хлеб тартин ржано-пшеничный","Хлеб тартин розовый"],
...
"RONDO Cromaster":["Булочка бриошь зерновая","Круассан мини","Круассан для сэндвича","Круассан французский","Круассан французский с сыром"],
...
"TRIMA":["Булочка для супа тёмная","Булочка чесночная","Булочка для Тануки с кунжутом","Булочка суповая светлая","Ватрушка с творогом","Ватрушка","Рогалик с вишней","Тесто для рогалика"],
